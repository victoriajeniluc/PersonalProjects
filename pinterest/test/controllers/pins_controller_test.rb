...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { created_on: @pin.created_on, description: @pin.description, title: @pin.title, updated_on: @pin.updated_on } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { created_on: @pin.created_on, description: @pin.description, title: @pin.title, updated_on: @pin.updated_on } }
